  ...
  <transition name="modal-fade">
    <div class="modal-backdrop">
      ...
      >
        ...
        >
          <slot name="header">
            Edytowanie kategorii {{CategoryToEdit.CategoryName}}
          </slot>
          <button
            type="button"
            class="btn-close"
            ...
            <div class="modal_body_container">
                <div class="modal_body_input_container">
                  <div class="modal_input_row">
                        ...
                        <input id="input_name_category_PL" v-model="categoryNamePL" class="modal_input_user_edit" />
                  </div>
                  <div class="modal_input_row">
                        <label class="modal_body_input_label"> Nazwa kategorii - angielski</label>
                        <input id="input_name_category_ENG" v-model="categoryNameENG" class="modal_input_user_edit" />
                  </div>
                  <div class="modal_input_row">
                        <label class="modal_body_input_label"> Nazwa kategorii - włoski</label>
                        <input id="input_name_category_IT" v-model="categoryNameIT" class="modal_input_user_edit" />
                  </div>
                </div>
                ...
                <div class="modal_body_input_container modal_add_image_horizontal">
                    ...
                    <div style="width:100%;" @click="selectFileClick">
                          <AddNewItemHorizontal style="background-position: center;background-size: contain; background-repeat: no-repeat" 
                              v-bind:style="{ 'background-image': 'url(' + img +'/categories/'+ CategoryToEdit.CategoryImagePath + ')' }" 
        ...
        <footer class="modal-footer">
          ...
          <button @click="upload" class="btn-yellow">Aktualizuj kategorię</button>
...
export default ({
    ...
    data(){
        return {
          ...
          categoryNamePL: this.CategoryToEdit.CategoryName,
          categoryNameENG: this.CategoryToEdit.CategoryNameENG,
          categoryNameIT: this.CategoryToEdit.CategoryNameIT,
         // categoryImage: null,
    ...
    methods:{
        ...
        upload() {
          ...
          this.categoryNamePL = document.getElementById('input_name_category_PL').value;
          this.categoryNameENG = document.getElementById('input_name_category_ENG').value;
          this.categoryNameIT =document.getElementById('input_name_category_IT').value;
          ...
          if(this.categoryNameENG===''){
            this.categoryNameENG = this.categoryNamePL;
          }

          if(this.categoryNameIT===''){
            this.categoryNameIT = this.categoryNamePL;
          }
          ...
          if(this.message===''){
            ...
            formData.append('sendimage', file);
              ...
              API.post(`/categories/category_update.php?category=${this.CategoryToEdit.ID}`,formData, {
                  headers: {
